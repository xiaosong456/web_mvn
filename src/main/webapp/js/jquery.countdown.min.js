...
(function(e) {
	e.fn.countdown = function(t, n) {
		function o() {
			...
			var h = Math.floor(o / c), p = Math.floor(o % c / l), d = Math
					.floor(o % l / f), v = Math.floor(o % f / a);
			h = String(h).length >= 2 ? h : "0" + h;
			p = String(p).length >= 2 ? p : "0" + p;
			d = String(d).length >= 2 ? d : "0" + d;
			v = String(v).length >= 2 ? v : "0" + v;
			var m = h === 1 ? r.day : r.days, g = p === 1 ? r.hour : r.hours, y = d === 1 ? r.minute
					: r.minutes, b = v === 1 ? r.second : r.seconds;
			i.find(".days").text(h);
			i.find(".hours").text(p);
		...
		var i = this;
		var s = function() {
			var e = new Date(2016,2,19);
			var n = new Date(e.getTime());
			return n;
		};
		var u = setInterval(o, 1);
	}
})(jQuery);